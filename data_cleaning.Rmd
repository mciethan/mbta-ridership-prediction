...
f19_clean %>% write.csv('data/stations_routes_f19_ridership.csv')
f23_clean %>% write.csv('data/stations_routes_f23_ridership.csv')
```
...
```{r}
rt_stations_f23 %>% write.csv('data/stations_routes_f23.csv', row.names=FALSE)
rt_stations_f19 %>% write.csv('data/stations_routes_f19.csv', row.names=FALSE)
```
...
rt_stations_f23 <- read.csv('data/stations_routes_f23.csv')
rt_stations_f19 <- read.csv('data/stations_routes_f19.csv')
```
...
walk_polys_f23 %>% clean_walk_polys() %>%
  write.csv('data/stations_routes_f23_geoms_overlapping.csv', row.names=FALSE)

walk_polys_f23_nonoverlap %>% clean_walk_polys() %>%
  write.csv('data/stations_routes_f23_geoms_nonoverlapping.csv', row.names=FALSE)

walk_polys_f19 %>% clean_walk_polys() %>%
  write.csv('data/stations_routes_f19_geoms_overlapping.csv', row.names=FALSE)

walk_polys_f19_nonoverlap %>% clean_walk_polys() %>%
  write.csv('data/stations_routes_f19_geoms_nonoverlapping.csv', row.names=FALSE)
```
...
rt_stations_f23 %>% join_ctps() %>% write.csv('data/stations_routes_f23_pnr_spaces.csv', row.names=FALSE)
rt_stations_f19 %>% join_ctps() %>% write.csv('data/stations_routes_f19_pnr_spaces.csv', row.names=FALSE)
```
