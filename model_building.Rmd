...
```{r}
continuous_vars <- c('avg_boardings', 'avg_headway', 'avg_trav_time_to_cbd', 
                     'walk_score', 'km_from_cbd', 'median_inc_1000s', 'pop_per_acre',
...
base_reg <- function(params) {
  eval(bquote(lm(.(as.symbol(params$y)) ~ avg_trav_time_to_cbd + 
